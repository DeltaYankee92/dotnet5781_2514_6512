...
namespace dotnet5781_00_2514_6512
{
    class Main_new1
    {
        ...
        List<LineStation> Stops = new List<LineStation>()
        {
        ...
        List<LineStation> Stops = new List<LineStation>()
        {
            ...
            new LineStation{BusStationKey = 945233, Latitude = 33.3651, Longitude = 121.3367, adress = "רינה ניקובה 13, ירושלים" },
            new LineStation{BusStationKey = 944326, Latitude = 33.1421, Longitude = 121.6421, adress = "רינה ניקובה 14, ירושלים" },
            new LineStation{BusStationKey = 634443, Latitude = 33.5231, Longitude = 121.3634, adress = "רינה ניקובה 15, ירושלים" },
            new LineStation{BusStationKey = 949443, Latitude = 33.7341, Longitude = 121.9561, adress = "רינה ניקובה 16, ירושלים" },
            new LineStation{BusStationKey = 634613, Latitude = 33.7462, Longitude = 121.0524, adress = "רינה ניקובה 17, ירושלים" },
            new LineStation{BusStationKey = 162542, Latitude = 33.3856, Longitude = 121.7421, adress = "רינה ניקובה 18, ירושלים" },
            new LineStation{BusStationKey = 946351, Latitude = 33.7462, Longitude = 121.7415, adress = "רינה ניקובה 19, ירושלים" },
            new LineStation{BusStationKey = 949522, Latitude = 33.3612, Longitude = 121.6161, adress = "רינה ניקובה 20, ירושלים" },
            new LineStation{BusStationKey = 952343, Latitude = 33.4251, Longitude = 121.6761, adress = "רינה ניקובה 21, ירושלים" },
            new LineStation{BusStationKey = 745443, Latitude = 33.3723, Longitude = 121.7451, adress = "רינה ניקובה 22, ירושלים" },
            new LineStation{BusStationKey = 948453, Latitude = 33.7364, Longitude = 121.0465, adress = "רינה ניקובה 23, ירושלים" },
            new LineStation{BusStationKey = 683443, Latitude = 33.8345, Longitude = 121.0465, adress = "רינה ניקובה 24, ירושלים" },
            new LineStation{BusStationKey = 906743, Latitude = 33.3583, Longitude = 121.0342, adress = "רינה ניקובה 25, ירושלים" },
        }
